...
class MyBot(irc.bot.SingleServerIRCBot):
    ...
    def on_welcome(self, c, e):
        from MessageHandlers import WikiLinkHandler, WikiStatsHandler
        ...
        site = 'http://finalfantasy.wikia.com/wiki/'

        self.chan_name_to_handlers = {}
        for chan in self.channels_to_join:
            chan_name = chan[0]
            c.join(chan_name)
            self.chan_name_to_handlers[chan_name] = [WikiLinkHandler(chan_name, site),
